---
title: 'Programme of Activities (PoA) for Vietnamese SMEs | Shared MRV Costs'
description: 'Learn how Vietnamese SMEs can jointly implement carbon projects through Programme of Activities (PoA) to share Measurement, Reporting, and Verification costs.'
seo:
  title: 'Programme of Activities (PoA) for Vietnamese SMEs | Grouped Carbon Projects'
  description: 'Discover how Vietnamese SMEs can share MRV costs through Programme of Activities. Learn about the hub-and-spoke model for grouped carbon credit projects.'
navigation:
  index: 8
---
